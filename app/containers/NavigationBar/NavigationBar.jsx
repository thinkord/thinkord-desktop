...
export class NavigationBar extends Component {
    ...
    changeMode = () => {
        ...
        if (document.getElementsByClassName("view-mode")[0].style.display === "flex") {
            document.getElementsByClassName("view-mode")[0].style.display = "none";         //show selectMode
            document.getElementsByClassName("select-mode")[0].style.display = "flex";
            Array.from(selectBox).forEach(block => {
                block.style.display = "block"
            });
        } else {
            document.getElementsByClassName("select-mode")[0].style.display = "none";        //show ViewMode
            document.getElementsByClassName("view-mode")[0].style.display = "flex";
            Array.from(selectBox).forEach(block => {
    ...
    render() {
        ...
        return (
            <div className='navigator-container'>
                ...
                <div className="navigation-bar view-mode" style={viewMode}>
                ...
                <div className="navigation-bar select-mode">
